...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, reference_points=None):
        ...
        masks = [masks[0].reshape(src_flatten.shape[0],200,282)]
        ...
        reference_points = self.reference_points(query_embed[0]).sigmoid()
        #     init_reference_out = reference_points
        # decoder
        hs, inter_references = self.decoder(query_embed[0], reference_points, src_flatten,
                                            spatial_shapes, level_start_index, valid_ratios, None, mask_flatten)
